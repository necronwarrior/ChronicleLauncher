...
namespace ChronicleLauncher
{
    ...
    public class OutlinedTextBlock : FrameworkElement
    {
        ...
        private void UpdatePen()
        {
            ...
            if (StrokePosition == EStrokePosition.Outside || StrokePosition == EStrokePosition.Inside)
            {
        ...
        public EStrokePosition StrokePosition
        {
            get { return (EStrokePosition)GetValue(StrokePositionProperty); }
        ...
        public static readonly DependencyProperty StrokePositionProperty =
            DependencyProperty.Register("StrokePosition",
                typeof(EStrokePosition),
                typeof(OutlinedTextBlock),
                new FrameworkPropertyMetadata(EStrokePosition.Outside, FrameworkPropertyMetadataOptions.AffectsRender));
        ...
        protected override void OnRender(DrawingContext drawingContext)
        {
            ...
            if (StrokePosition == EStrokePosition.Outside)
            {
                drawingContext.PushClip(_clipGeometry);
            }
            else if (StrokePosition == EStrokePosition.Inside)
            {
